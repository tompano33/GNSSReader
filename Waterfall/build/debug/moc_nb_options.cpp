...
void CNbOptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CNbOptions *_t = static_cast<CNbOptions *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CNbOptions::*_t)(int , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CNbOptions::thresholdChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CNbOptions::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CNbOptions.data,
      qt_meta_data_CNbOptions,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CNbOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CNbOptions.stringdata0))
        return static_cast<void*>(const_cast< CNbOptions*>(this));
