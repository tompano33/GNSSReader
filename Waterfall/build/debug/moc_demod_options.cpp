...
QT_MOC_LITERAL(8, 80, 27), // "on_maxdevSelector_activated"
QT_MOC_LITERAL(9, 108, 5), // "index"
QT_MOC_LITERAL(10, 114, 25), // "on_emphSelector_activated"
QT_MOC_LITERAL(11, 140, 22), // "on_dcrCheckBox_toggled"
QT_MOC_LITERAL(12, 163, 7) // "checked"
    ...
    "on_dcrCheckBox_toggled\0checked"
};
...
void CDemodOptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_maxdevSelector_activated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->on_emphSelector_activated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->on_dcrCheckBox_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CDemodOptions::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CDemodOptions::fmMaxdevSelected)) {
                *result = 0;
            }
        }
        {
            typedef void (CDemodOptions::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CDemodOptions::fmEmphSelected)) {
                *result = 1;
            }
        }
        {
            typedef void (CDemodOptions::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CDemodOptions::amDcrToggled)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject CDemodOptions::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CDemodOptions.data,
      qt_meta_data_CDemodOptions,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
