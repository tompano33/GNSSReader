...
#ifndef STREAMTRANSLATOR_H_H
#define STREAMTRANSLATOR_H_H
...
{
	/**
	* Class implements xml translation for Stream Type.
	*/
	class StreamTranslator : public Translator
	{
